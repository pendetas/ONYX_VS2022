        ...
        <div class="onyx-account-layout">
            <aside class="onyx-account-sidebar">
                ...
                <nav class="onyx-account-nav" aria-label="Account navigation">
                    ...
                    <a class="is-active" href="/customer_page/onyx_reviews">
                ...
                <section class="onyx-account-section">
                    ...
                    <asp:Panel ID="pnlReviewForm" runat="server">
                            ...
                            <div class="onyx-review-field">
                                ...
                                <div class="onyx-star-rating" data-rating-select="<%= ddlRating.ClientID %>">
                                    <div class="onyx-star-row" role="radiogroup" aria-label="Choose review rating">
                                        <button type="button" class="onyx-star-button" data-rating="1" aria-label="1 star" aria-pressed="false"></button>
                                        <button type="button" class="onyx-star-button" data-rating="2" aria-label="2 stars" aria-pressed="false"></button>
                                        <button type="button" class="onyx-star-button" data-rating="3" aria-label="3 stars" aria-pressed="false"></button>
                                        <button type="button" class="onyx-star-button" data-rating="4" aria-label="4 stars" aria-pressed="false"></button>
                                        <button type="button" class="onyx-star-button" data-rating="5" aria-label="5 stars" aria-pressed="false"></button>
                                    </div>
                        ...
                        <div class="onyx-settings-actions">
                            <asp:Button ID="btnSubmitReview" runat="server" Text="Submit Review" CssClass="onyx-review-submit" OnClick="btnSubmitReview_Click" />
