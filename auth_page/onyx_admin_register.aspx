<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="onyx_admin_register.aspx.cs" Inherits="ONYX_DDAC.auth_page.onyx_admin_register" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Admin Register &mdash; ONYX</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .submit-btn {
            ...
            box-shadow: inset 0 1px 0 rgba(255,255,255,0.85), 0 8px 30px rgba(0,0,0,0.35);
        }

        .submit-btn::before {
            content: ''; position: absolute; inset: 0;
            background: var(--silver); opacity: 0;
            transition: opacity 0.28s; border-radius: 16px;
        }
        ...
        <div class="admin-wrap">
            <div class="glass-card" id="glassCard">
                <div class="card-inner">
                    ...
                    <p class="card-badge">Create Admin Account</p>

                    <asp:Label ID="lblError"   runat="server" CssClass="admin-error"   Visible="false" />
                    <asp:Label ID="lblSuccess" runat="server" CssClass="admin-success" Visible="false" />

                    <div class="field-row">
                        <div class="field">
                            <label class="field-lbl" for="<%= txtFullName.ClientID %>">Full Name</label>
                            <asp:TextBox ID="txtFullName" runat="server" CssClass="field-input" placeholder="Your name"
                                data-gramm="false" data-gramm_editor="false" />
                        </div>
                        <div class="field">
                            <label class="field-lbl" for="<%= txtUsername.ClientID %>">Username</label>
                            <asp:TextBox ID="txtUsername" runat="server" CssClass="field-input" placeholder="Choose one"
                                data-gramm="false" data-gramm_editor="false" />
                        </div>
                    </div>

                    <div class="field">
                        <label class="field-lbl" for="<%= txtEmail.ClientID %>">Email</label>
                        <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" CssClass="field-input" placeholder="admin@example.com"
                            data-gramm="false" data-gramm_editor="false" />
                    </div>

                    <div class="field-row">
                        <div class="field">
                            <label class="field-lbl" for="<%= txtPassword.ClientID %>">Password</label>
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="field-input" placeholder="Min 8 chars"
                                data-gramm="false" data-gramm_editor="false" />
                        </div>
                        <div class="field">
                            <label class="field-lbl" for="<%= txtConfirm.ClientID %>">Confirm</label>
                            <asp:TextBox ID="txtConfirm" runat="server" TextMode="Password" CssClass="field-input" placeholder="Repeat"
                                data-gramm="false" data-gramm_editor="false" />
                        </div>
                    </div>

                    <div class="submit-wrap">
                        <asp:LinkButton ID="btnRegister" runat="server" CssClass="submit-btn"
                    ...
                    <p class="card-footer">
                        ...
                        <a href="onyx_Admin_Login.aspx">Sign in</a>
                    </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            tl.to('.bg-word',         { opacity: 1, duration: 2.2, ease: 'power2.out' }, 0)
              ...
              .from('.field, .field-row', { y: 12, opacity: 0, stagger: 0.08, duration: 0.7 }, 0.68)
