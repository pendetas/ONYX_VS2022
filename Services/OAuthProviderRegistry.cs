...
namespace ONYX_DDAC.Services
{
    public static class OAuthProviderRegistry
    {
            ...
            new Dictionary<string, OAuthProviderOptions>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                },
                {
                    ...
                    new OAuthProviderOptions
                    {
                        ...
                        UserInfoEndpoint = "https://graph.facebook.com/v20.0/me?fields=id,name,email,picture",
                        Scope = "email",
                        ClientIdSettingKey = "FacebookClientId",
                        ClientSecretSettingKey = "FacebookClientSecret",
                        ClientIdEnvironmentKey = "FACEBOOK_CLIENT_ID",
                        ClientSecretEnvironmentKey = "FACEBOOK_CLIENT_SECRET"
                    }
                },
                {
                    "x",
        ...
        public static string GetStateModeSessionKey(string state)
        {
            return "OAuthMode:" + state;
        }
    }
}
